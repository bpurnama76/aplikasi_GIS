<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Update Data SIMB</h1>
		</div>
	</div><!--/.row-->
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="panel-body">
						<?php echo form_open('data/edit_simb','role="form" class="form-group"',);?>
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
								<label for="nomor_izin">Nomor SIMB</label>
									<input type="text" value="<?php echo $simb['nomor_izin']?>" name="nomor_izin" class=" form-control" placeholder="Nomor SIMB yang akan didaftarkan"></input>
								</div>
							</div>
							<div class="col-md-6">
								<div class="position-relative form-group">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" value="<?php echo $simb['luas_bangunan']?>" name="luas" placeholder="Luas dalam Kilometer" class="form-control"></input>
								</div>
							</div>
							<div class="col-md-3">
								<div class="position-relative form-group">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" value="<?php echo $simb['longitude']?>" placeholder="Deteksi dari Peta" name="longitude" class="form-control"></input>
								</div>
							</div>
							<div class="col-md-6">
								<div class="position-relative form-group">
									<label for="luas">Latitude</label>
									<input type="text" value="<?php echo $simb['latitude']?>" placeholder="Deteksi dari Peta" name="latitude" class="form-control"></input>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<textarea type="text" placeholder="<?php echo $simb['lokasi_bangunan']?>" name="lokasi_bangunan" class="form-control"></textarea>
								</div>
							</div>
							<div class="col-md-6">
								<div class="position-relative form-group">
									<label for="kategori">Tanggal Datar Aktif</label>
									<input type="date" value="<?php echo $simb['tanggal_izin']?>" name="tanggal" class="form-control"></input>
								</div>
							</div>
						</div>
						<div class="row">
